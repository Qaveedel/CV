...
const CREDITS = [
    {
        ...
        rows: [['Ali Qavidel', 'All']],
    },
    {
        title: 'Modeling & Texturing',
        rows: [
            ['Ali Qavidel', 'Texturing, Composition, & UV'],
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Ali Qavidel', 'Mixing, Composition, & Foley'],
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2025 Ali Qavidel'}
        >
            <div
